...
class WooCommerceWholeSalePrices {
    ...
    public function declare_hpos_incompatibility() {
        if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
            \Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'custom_order_tables', 'woocommerce-wholesale-prices/woocommerce-wholesale-prices.bootstrap.php', false );
        }
    }
