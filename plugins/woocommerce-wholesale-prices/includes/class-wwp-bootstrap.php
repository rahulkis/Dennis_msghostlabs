    ...
    class WWP_Bootstrap {
        ...
        public function getting_started_notice() {
            ...
            if ( current_user_can( 'manage_woocommerce' ) && get_option( 'wwp_admin_notice_getting_started_show' ) === 'yes' ) {
                ...
                if (
                    in_array( $screen->id, array( 'wholesale_page_order-forms', 'wholesale_page_wholesale-settings', 'settings_page_wwc_license_settings', 'wholesale_page_wwpp-wholesale-roles-page', 'wholesale_page_wwc_license_settings' ), true ) ||
