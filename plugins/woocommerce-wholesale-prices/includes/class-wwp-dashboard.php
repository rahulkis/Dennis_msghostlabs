...
if ( ! class_exists( 'WWP_Dashboard' ) ) {
    ...
    class WWP_Dashboard {
         ...
         * @access public
         *
         * @param bool $recheck_plugin_status Recheck plugin status.
         * @return array
         */
        public function get_wws_plugins_license_statuses( $recheck_plugin_status = false ) {
            ...
            if ( $this->enable_dashboard_cache() && ! empty( $cache ) && false === $recheck_plugin_status ) {
                return $cache;
            }
         ...
         * @access public
         *
         * @param array $wws_license_statuses WWS License Statuses.
         * @return array
         */
        public function wholesale_prices_premium_license_cache( $wws_license_statuses ) {
            ...
            if ( WWP_Helper_Functions::is_wwpp_active() && WWP_Helper_Functions::check_wws_plugin_min_version( 'wwpp', '1.27.3' ) ) {
                ...
                if ( isset( $wwpp_status['status'] ) && 'success' === $wwpp_status['status'] ) {
                ...
                } elseif ( isset( $wwpp_status['error_msg'] ) && strpos( $wwpp_status['error_msg'], 'This license is currently disabled' ) !== false ) {
                ...
                } elseif ( isset( $wwpp_status['expired_date'] ) ) {
                ...
                } elseif ( isset( $wwpp_status['error_msg'] ) ) {
                    ...
                    } elseif ( strpos( $wwpp_status['error_msg'], 'Invalid activation email' ) !== false ) {
        ...
        public function wholesale_order_form_license_cache( $wws_license_statuses ) {
            ...
            if ( WWP_Helper_Functions::is_wwof_active() && WWP_Helper_Functions::check_wws_plugin_min_version( 'wwof', '1.21.2' ) ) {
                ...
                if ( isset( $wwof_status['status'] ) && 'success' === $wwof_status['status'] ) {
                ...
                } elseif ( isset( $wwof_status['error_msg'] ) && strpos( $wwof_status['error_msg'], 'This license is currently disabled' ) !== false ) {
                ...
                } elseif ( isset( $wwof_status['expired_date'] ) ) {
                ...
                } elseif ( isset( $wwof_status['error_msg'] ) ) {
                    ...
                    } elseif ( strpos( $wwof_status['error_msg'], 'Invalid activation email' ) !== false ) {
        ...
        public function wholesale_lead_capture_license_cache( $wws_license_statuses ) {
            ...
            if ( WWP_Helper_Functions::is_wwlc_active() && WWP_Helper_Functions::check_wws_plugin_min_version( 'wwlc', '1.17.1' ) ) {
                ...
                if ( isset( $wwlc_status['status'] ) && 'success' === $wwlc_status['status'] ) {
                ...
                } elseif ( isset( $wwlc_status['error_msg'] ) && strpos( $wwlc_status['error_msg'], 'This license is currently disabled' ) !== false ) {
                ...
                } elseif ( isset( $wwlc_status['expired_date'] ) ) {
                ...
                } elseif ( isset( $wwlc_status['error_msg'] ) ) {
                    ...
                    } elseif ( strpos( $wwlc_status['error_msg'], 'Invalid activation email' ) !== false ) {
         ...
         * @access public
         */
        public function clear_license_cache_on_version_check() {
