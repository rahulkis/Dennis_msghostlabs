...
if ( ! class_exists( 'WWP_Admin_Custom_Fields_Variable_Product' ) ) {
    ...
    class WWP_Admin_Custom_Fields_Variable_Product {
         ...
         */
        public function add_wholesale_sale_price_dummy_fields( $loop, $variation_data, $variation, $role, $role_key, $currency_symbol, $wholesale_price, $discount_type, $wholesale_percentage_discount ) {
