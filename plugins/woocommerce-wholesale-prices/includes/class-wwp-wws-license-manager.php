    ...
    class WWP_WWS_License_Manager {
        ...
        public function wwpp_license_tab() {
            ...
            if ( isset( $_GET['tab'] ) ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                $tab = $_GET['tab']; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
            } else {
        ...
        public function wwof_license_tab() {
            ...
            if ( isset( $_GET['tab'] ) && 'wwof' === $_GET['tab'] ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                $tab = $_GET['tab']; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
            } else {
                $tab = '';
            }
        ...
        public function wwlc_license_tab() {
            ...
            if ( isset( $_GET['tab'] ) && 'wwlc' === $_GET['tab'] ) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
                $tab = $_GET['tab']; // phpcs:ignore WordPress.Security.NonceVerification.Recommended
            } else {
                $tab = '';
            }
        ...
        public function remove_premium_plugins_admin_menu() {
            ...
            if ( WWP_Helper_Functions::is_wwof_active() ) {
                ...
                if ( ! empty( $wc_wholesale_order_form->_wwof_license_manager ) ) {
                    remove_action(
                        'admin_menu',
                        array(
                            $wc_wholesale_order_form->_wwof_license_manager,
                            'register_wws_license_settings_menu',
                        ),
                        99
                    );
                }
