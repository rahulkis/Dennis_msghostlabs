<div id="sbi-builder-app" class="sbi-fb-fs sbi-builder-app" :data-app-loaded="appLoaded ? 'true' : 'false'" :data-disable-pro="shouldDisableProFeatures ? 'true' : 'false'" :class="shouldDisableProFeatures == true && iscustomizerScreen ? 'sbi-builder-app-lite-dismiss' : '' " >
	<?php
