...
class SBI_Source {
	...
	public static function get_connection_urls( $is_settings = false ) {
		...
		$urls['personal'] = 'https://connect.smashballoon.com/auth/ig/?wordpress_user=&v=pro&vn=' . SBIVER . '&sbi_con=' . $nonce;
		$urls['business'] = 'https://connect.smashballoon.com/auth/ig/?wordpress_user=&v=pro&vn=' . SBIVER . '&sbi_con=' . $nonce;
