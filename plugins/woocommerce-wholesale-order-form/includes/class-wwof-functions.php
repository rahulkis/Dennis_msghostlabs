...
class WWOF_Functions
{
     ...
     * @since 1.18 WWP is now required to fully use WWOF
     * @return array
     */
    public static function wwof_check_plugin_dependencies()
    {
        ...
        $new_required_plugins = array('woocommerce/woocommerce.php', 'woocommerce-wholesale-prices/woocommerce-wholesale-prices.bootstrap.php');
        $requiredPlugins      = apply_filters('wwof_required_plugins', $new_required_plugins);
