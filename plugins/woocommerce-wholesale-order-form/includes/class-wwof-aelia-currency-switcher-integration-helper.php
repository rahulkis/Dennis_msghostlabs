...
if ( !class_exists( 'WWOF_ACS_Integration_Helper' ) ) {
     ...
     */
    class WWOF_ACS_Integration_Helper {
        ...
        public static function aelia_currency_switcher_active() {
            ...
            return is_plugin_active( 'woocommerce-aelia-currencyswitcher/woocommerce-aelia-currencyswitcher.php' );
