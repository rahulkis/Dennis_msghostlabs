		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
						{
							label: "<?php echo esc_js( __( 'Gift card balance issued', 'woocommerce-gift-cards' ) ); ?>",
						...
						{
							label: "<?php echo esc_js( __( 'Gift card balance used', 'woocommerce-gift-cards' ) ); ?>",
						...
						{
							label: "<?php echo esc_js( __( 'Gift card balance expired', 'woocommerce-gift-cards' ) ); ?>",
