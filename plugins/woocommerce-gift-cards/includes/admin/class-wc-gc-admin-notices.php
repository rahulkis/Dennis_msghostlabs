...
class WC_GC_Admin_Notices {
	...
	public static function welcome_notice() {
		...
		<h2 class="sw-welcome-title"><?php esc_attr_e( 'Ready to start offering and accepting Gift Cards?', 'woocommerce-gift-cards' ); ?></h2>
		<p class="sw-welcome-text"><?php esc_attr_e( 'Thank you for installing WooCommerce Gift Cards.', 'woocommerce-gift-cards' ); ?><br/><?php esc_attr_e( 'Let\'s get started by creating and selling your first Gift Card.', 'woocommerce-gift-cards' ); ?></p>
		<a href="<?php echo esc_url( admin_url( 'post-new.php?post_type=product&todo=giftcard' ) ); ?>" class="sw-welcome-button button-primary"><?php esc_attr_e( 'Let\'s go!', 'woocommerce-gift-cards' ); ?></a>
		<?php
	...
	public static function update_order_stats_notice() {
		...
		if ( ! WC_GC_Admin_Analytics::is_order_stats_update_actioned() ) {
		...
		} elseif ( WC_GC_Admin_Analytics::is_order_stats_update_queued() ) {
