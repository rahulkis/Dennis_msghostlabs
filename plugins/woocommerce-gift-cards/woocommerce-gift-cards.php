...
class WC_Gift_Cards {
	...
	public function get_resource_url( $handle ) {
		...
		if ( 'update-php' === $handle ) {
			...
			$resource = 'https://docs.woocommerce.com/document/gift-cards/';
		} elseif ( 'guide' === $handle ) {
			$resource = 'https://docs.woocommerce.com/document/gift-cards/store-owners-guide/';
		} elseif ( 'guide-multi-prepaid-tax' === $handle ) {
			$resource = 'https://docs.woocommerce.com/document/gift-cards/store-owners-guide/#understanding-gift-cards';
		} elseif ( 'faq-multi-prepaid-revenue' === $handle ) {
			$resource = 'https://docs.woocommerce.com/document/gift-cards/faq/#gift-cards-accounting-revenue';
