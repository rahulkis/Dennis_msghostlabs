...
class GFKlaviyoAPI extends GFFeedAddOn {
        ...
        if ($this->get_plugin_setting('private_api_key')) {
			...
			$post_data = array(
				...
				'profiles' => array(array(
					'email' => $merge_vars['email'],
					'$consent' => 'email',
					'$source' => 'Gravity Form: ' . $form['title'],
					'Birthday' => $merge_vars['birthday'],
				))
			);
	 ...
	 */
	 public function plugin_settings_fields() {
	 	return array(
	 		array(
	 			'title'  => 'Insert your Klaviyo API keys below to connect. You can find them on your Klaviyo account page.', 'klaviyoaddon',
	 			'fields' => array(
	 				array(
	 					'name'    => 'api_key',
				...
				'fields' => array(
					...
					array(
						...
						'field_map' => array(
							...
							array(
								'name'     => 'birthday',
								'label'    => esc_html__( 'Birthday', 'klaviyoaddon' )
							),
						),
					),
					array(
