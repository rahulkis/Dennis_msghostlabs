 ...
 * @since 1.17.4
 */
class WWLC_Email_New_Wholesale_Lead extends WC_Email {
    ...
    public function __construct() {
        $this->id                    = 'wwlc_email_new_wholesale_lead';
        $this->customer_email        = false;
        $this->recipient             = $this->get_option( 'recipient', WWLC_Emails::get_admin_email_recipients() );
        $this->title                 = __( 'New wholesale lead (Admin)', 'woocommerce-wholesale-lead-capture' );
        $this->description           = __( 'Email sent to admin on every successful new user registration.', 'woocommerce-wholesale-lead-capture' );
    ...
    public function get_default_subject() {
        return __( 'New Wholesale Lead', 'woocommerce-wholesale-lead-capture' );
    }
    ...
    public function get_default_message() {
        $default_message = '<p>' . __( 'A new wholesale lead just registered for an account,', 'woocommerce-wholesale-lead-capture' ) . '</p><p>' .
    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            ...
            'subject'    => array(
                ...
                'type'        => 'text',
                'placeholder' => __( 'New Wholesale Lead', 'woocommerce-wholesale-lead-capture' ),
                'desc_tip'    => true,
