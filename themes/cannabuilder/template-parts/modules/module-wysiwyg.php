...
<div id="<?php echo 'module-' . $index; ?>" class="module module-text module-padded-top module-padded-bottom module-setting-bg-<?php echo $bg_color; ?> module-setting-columns-<?php echo $columns; ?> <?php echo 'module-' . $index; ?>">
